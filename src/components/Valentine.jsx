...
const noMessages = [
    ...
    "Crush… that button is starting to look suspicious 😏",
                ...
                <main className="relative z-10 w-[92vw] max-w-xl rounded-3xl p-8 text-center shadow-2xl bg-white/80 backdrop-blur-xl">
                    ...
                    {step === "intro" && (
                        <div className="animate-pop">
                            <h1 className="text-4xl font-extrabold mb-6">Hey Crush 💕</h1>
                    ...
                    {step === "celebration" && (
                        <div className="animate-pop">
                            ...
                            <img
                                ...
                                src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXF5MzBnN2d0OHlvdDhuczB1MmhwZm9uMnJyNmU3cmlkdHMxeGUzYSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/5dUllWbKVlaqmMTvHb/giphy.gif"
                                alt="Fireworks"
                            />
                        </div>
                    )}
